...
public class Detector : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        moveCore = PlayerReferences.instance.movementCore;
        playerCol = PlayerReferences.instance.col;
        playerT = PlayerReferences.instance.transform;
    ...
    {
        groundSensor = new Sensor(playerT, playerCol);
        groundSensor.SetCastDirection(Sensor.CastDirection.Down);

        float safetyDistanceFactor = 0.001f;
        groundSensor.SetCastLength(colliderHeight * 0.5f + safetyDistanceFactor);
    }

    public void Check()
    {
        groundSensor.SetCastOrigin(playerT.position);
        groundSensor.Cast();
    }
